...
const REGIONES_Y_COMUNAS = {
    "regiones": [
        ...
        { "nombre": "Libertador General Bernardo O'Higgins", "comunas": ["Rancagua", "Codegua", "Coinco", "Coltauco", "Doñihue", "Graneros", "Las Cabras", "Machalí", "Malloa", "Mostazal", "Olivar", "Peumo", "Pichidegua", "Quinta de Tilcoco", "Rengo", "Requínoa", "San Vicente", "Pichilemu", "La Estrella", "Litueche", "Marchihue", "Navidad", "Paredones", "San Fernando", "Chépica", "Chimbarongo", "Lolol", "Nancagua", "Palmilla", "Peralillo", "Placilla", "Pumanque", "Santa Cruz"] },
        ...
        { "nombre": "Magallanes y de la Antártica Chilena", "comunas": ["Punta Arenas", "Laguna Blanca", "Río Verde", "San Gregorio", "Cabo de Hornos (Ex Navarino)", "Antártica", "Porvenir", "Primavera", "Timaukel", "Natales", "Torres del Paine"] }
    ]
};
...
function cargarRegiones(idRegionSelect, idComunaSelect) {
    ...
    regionSelect.innerHTML = '<option value="" selected disabled>Seleccione una región</option>';
    REGIONES_Y_COMUNAS.regiones.forEach(region => {
        const option = document.createElement('option');
        option.value = region.nombre; // Guardamos el nombre como valor
        option.textContent = region.nombre;
        regionSelect.appendChild(option);
    });

    // Event listener para cargar comunas cuando se cambia la región
