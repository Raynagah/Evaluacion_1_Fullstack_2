    ...
    function renderizarCarrito() {
        ...
        if (carrito.length === 0) {
            ...
            carrito.forEach(producto => {
                const subtotalProducto = producto.precio * producto.cantidad; // Ahora esto nunca será NaN
                ...
                tr.innerHTML = `
                    ...
                    <td>
                        <button class="btn btn-sm btn-outline-danger btn-eliminar" data-id="${producto.id}">&times;</button>
                    </td>
                `;
